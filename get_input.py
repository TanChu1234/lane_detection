...
def annotate_image(image_in,i):
    ...
    cv2.imwrite(f"D:\Lane Detection\lane_detection-master\lane_detection-master\label\label{i}.png", line_image)
...
a = 1
img = cv2.resize(cv2.imread("D:\Lane Detection\lane_detection-master\lane_detection-master\img\pic" + str(a)+".jpg"), (640,480))
# img = cv2.imread(r"D:\Lane Detection\lane_detection-master\lane_detection-master\img\pic0.jpg")
########################################################################################
annotated_image = annotate_image(img, a)
